...
build/vendor/bin/drush -r build/web pm:enable commerce -y
build/vendor/bin/drush -r build/web pm:enable commerce_cart -y
build/vendor/bin/drush -r build/web pm:enable commerce_order -y
build/vendor/bin/drush -r build/web pm:enable commerce_price -y
build/vendor/bin/drush -r build/web pm:enable commerce_store -y
build/vendor/bin/drush -r build/web pm:enable commerce_number_pattern -y
build/vendor/bin/drush -r build/web pm:enable commerce_product -y
build/vendor/bin/drush -r build/web pm:enable commerce_checkout -y
build/vendor/bin/drush -r build/web pm:enable commerce_payment -y
build/vendor/bin/drush -r build/web pm:enable commerce_promotion -y
build/vendor/bin/drush -r build/web pm:enable commerce_tax -y
